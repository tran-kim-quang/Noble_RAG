...
def parse_args():
    ...
    parser.add_argument('-l', type=int, default=_env_int("LIVETALKING_L", 10))
    parser.add_argument('-m', type=int, default=_env_int("LIVETALKING_M", 8))
    parser.add_argument('-r', type=int, default=_env_int("LIVETALKING_R", 10))
    ...
    parser.add_argument('--batch_size', type=int, default=_env_int("LIVETALKING_BATCH_SIZE", 16), help="infer batch")
    ...
    parser.add_argument('--REF_FILE', type=str, default=(os.getenv("LIVETALKING_REF_FILE") or "vi-VN-HoaiMyNeural"),
                        help="参考文件名或语音模型ID")
